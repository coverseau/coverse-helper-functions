...
/*
 ...
 Update URI:   https://github.com/coverseau/coverse-helper-functions
 */
...
// Usage: [subtract-fields total=x removed=y type=total].
// Replace x with the id of the field that holds the initial total and y with the id of the field that holds the amount being subtracted from the total.
...
// Usage: [frm-age-from-years year=YYYY id=x type=average].
// Replace YYYY with the initial year value (or don't include it at all, and the current year will be used) and x with the id of the field that holds the amount being subtracted from the year.
